...
namespace Myspace
{
    ...
    class Program
    {
        public static void Main(String[] args)
        {
            ...
            int mage1Health = 85;
            int warrior1Health = 105;
            int archer1Health = 95;

            int mage1Attack = 25;
            int warrior1Attack = 30;
            int archer1Attack = 20;

            int mage2Health = 85;
            int warrior2Health = 105;
            int archer2Health = 95;

            int mage2Attack = 25;
            int warrior2Attack = 30;
            int archer2Attack = 20;
            ...
            do
            {
                ...
                else if(choose == 1 && choose2 == 1)
                {
                    ...
                    for (int i = 0; i < 99; i++)
                    {
                        ...
                        archer2Health -= warrior2.Attack(archer1Attack, Attack.Physical, 1, weather);
                        archer1Health -= warrior1.Attack(archer2Attack, Attack.Physical, 1, weather);
